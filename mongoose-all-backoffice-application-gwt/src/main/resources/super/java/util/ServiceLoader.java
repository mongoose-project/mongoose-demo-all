...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.base.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.crm.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.crm.backoffice.activities.letters.RouteToLettersRequestEmitter::new, mongoose.crm.backoffice.activities.users.RouteToUsersRequestEmitter::new, mongoose.crm.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new, mongoose.event.backoffice.activities.events.RouteToEventsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.income.RouteToIncomeRequestEmitter::new, mongoose.ecommerce.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, mongoose.hotel.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new, mongoose.catering.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new);
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.crm.client.activities.login.LoginUiRoute::new, mongoose.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.base.backoffice.activities.monitor.MonitorUiRoute::new, mongoose.base.backoffice.activities.operations.OperationsUiRoute::new, mongoose.crm.backoffice.activities.authorizations.AuthorizationsUiRoute::new, mongoose.crm.backoffice.activities.letters.LettersUiRoute::new, mongoose.crm.backoffice.activities.letter.LetterUiRoute::new, mongoose.crm.backoffice.activities.users.UsersUiRoute::new, mongoose.crm.backoffice.activities.organizations.OrganizationsUiRoute::new, mongoose.event.backoffice.activities.events.EventsUiRoute::new, mongoose.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, mongoose.ecommerce.backoffice.activities.income.IncomeUiRoute::new, mongoose.ecommerce.backoffice.activities.payments.PaymentsUiRoute::new, mongoose.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, mongoose.ecommerce.backoffice.activities.statements.StatementsUiRoute::new, mongoose.hotel.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new, mongoose.event.backoffice.activities.cloneevent.CloneEventUiRoute::new, mongoose.event.backoffice.activities.options.EditableOptionsUiRoute::new, mongoose.catering.backoffice.activities.diningareas.DiningAreasUiRoute::new);
            case "dev.webfx.framework.shared.orm.entity.EntityFactoryProvider": return new ServiceLoader<S>(mongoose.base.shared.entities.impl.AttendanceImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.CartImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.CountryImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.DateInfoImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.DocumentImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.DocumentLineImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.EventImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.FilterImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.GatewayParameterImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.HistoryImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.ImageImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.ItemFamilyImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.ItemImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.LabelImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.MailImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.MethodImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.MoneyTransferImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.OptionImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.OrganizationImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.OrganizationTypeImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.PersonImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.RateImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.SiteImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.SystemMetricsEntityImpl.ProvidedFactory::new, mongoose.base.shared.entities.impl.TeacherImpl.ProvidedFactory::new);
            ...
            case "dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceBundle": return new ServiceLoader<S>(mongoose.all.backoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "dev.webfx.platform.shared.services.boot.spi.ApplicationJob": return new ServiceLoader<S>(mongoose.base.client.jobs.sessionrecorder.ClientSessionRecorderJob::new, dev.webfx.framework.client.jobs.querypush.QueryPushClientJob::new);
            case "dev.webfx.platform.shared.services.boot.spi.ApplicationModuleBooter": return new ServiceLoader<S>(dev.webfx.kit.launcher.WebFxKitLauncherModuleBooter::new, dev.webfx.platform.shared.services.boot.spi.impl.ApplicationJobsBooter::new, dev.webfx.platform.shared.services.serial.SerialCodecModuleBooter::new, dev.webfx.platform.shared.services.buscall.BusCallModuleBooter::new, mongoose.base.client.operationactionsloading.MongooseClientOperationActionsLoader::new, dev.webfx.framework.shared.interceptors.dqlquery.DqlQueryInterceptorModuleBooter::new, dev.webfx.framework.shared.interceptors.dqlquerypush.DqlQueryPushInterceptorModuleBooter::new, dev.webfx.framework.shared.interceptors.dqlsubmit.DqlSubmitInterceptorModuleBooter::new, dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceModuleBooter::new);
            ...
            case "dev.webfx.platform.shared.services.buscall.spi.BusCallEndpoint": return new ServiceLoader<S>(dev.webfx.platform.shared.services.query.ExecuteQueryBusCallEndpoint::new, dev.webfx.platform.shared.services.query.ExecuteQueryBatchBusCallEndpoint::new, dev.webfx.platform.shared.services.submit.ExecuteSubmitBusCallEndpoint::new, dev.webfx.platform.shared.services.submit.ExecuteSubmitBatchBusCallEndpoint::new, dev.webfx.framework.shared.services.querypush.ExecuteQueryPushBusCallEndpoint::new);
            ...
            case "dev.webfx.platform.shared.services.serial.spi.SerialCodec": return new ServiceLoader<S>(dev.webfx.platform.shared.datascope.aggregate.AggregateScope.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.serial.spi.impl.ProvidedBatchSerialCodec::new, dev.webfx.platform.shared.services.query.QueryArgument.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.query.QueryResult.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.buscall.BusCallArgument.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.buscall.BusCallResult.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.buscall.SerializableAsyncResult.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.submit.SubmitArgument.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.submit.SubmitResult.ProvidedSerialCodec::new, dev.webfx.platform.shared.services.submit.GeneratedKeyBatchIndex.ProvidedSerialCodec::new, dev.webfx.framework.shared.services.querypush.QueryPushArgument.ProvidedSerialCodec::new, dev.webfx.framework.shared.services.querypush.QueryPushResult.ProvidedSerialCodec::new, dev.webfx.framework.shared.services.querypush.diff.impl.QueryResultTranslation.ProvidedSerialCodec::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(mongoose.all.backoffice.application.MongooseBackOfficeApplication::new);
