...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.crm.client.activities.login.LoginUiRoute::new, mongoose.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.ecommerce.frontoffice.activities.person.PersonUiRoute::new, mongoose.ecommerce.frontoffice.activities.summary.SummaryUiRoute::new, mongoose.ecommerce.frontoffice.activities.cart.CartUiRoute::new, mongoose.ecommerce.frontoffice.activities.contactus.ContactUsUiRoute::new, mongoose.event.frontoffice.activities.options.OptionsUiRoute::new, mongoose.ecommerce.frontoffice.activities.payment.PaymentUiRoute::new, mongoose.event.frontoffice.activities.startbooking.StartBookingUiRoute::new, mongoose.event.frontoffice.activities.terms.TermsUiRoute::new, mongoose.event.frontoffice.activities.fees.FeesUiRoute::new, mongoose.event.frontoffice.activities.program.ProgramUiRoute::new);
