...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, mongoose.base.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.crm.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.crm.backoffice.activities.letters.RouteToLettersRequestEmitter::new, mongoose.crm.backoffice.activities.users.RouteToUsersRequestEmitter::new, mongoose.crm.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new, mongoose.event.backoffice.activities.events.RouteToEventsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.income.RouteToIncomeRequestEmitter::new, mongoose.ecommerce.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, mongoose.hotel.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new, mongoose.catering.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new);
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.crm.client.activities.login.LoginUiRoute::new, mongoose.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.event.backoffice.activities.cloneevent.CloneEventUiRoute::new, mongoose.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, mongoose.base.backoffice.activities.monitor.MonitorUiRoute::new, mongoose.base.backoffice.activities.operations.OperationsUiRoute::new, mongoose.crm.backoffice.activities.authorizations.AuthorizationsUiRoute::new, mongoose.crm.backoffice.activities.letters.LettersUiRoute::new, mongoose.crm.backoffice.activities.letter.LetterUiRoute::new, mongoose.crm.backoffice.activities.users.UsersUiRoute::new, mongoose.crm.backoffice.activities.organizations.OrganizationsUiRoute::new, mongoose.event.backoffice.activities.events.EventsUiRoute::new, mongoose.ecommerce.backoffice.activities.income.IncomeUiRoute::new, mongoose.ecommerce.backoffice.activities.payments.PaymentsUiRoute::new, mongoose.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, mongoose.ecommerce.backoffice.activities.statements.StatementsUiRoute::new, mongoose.hotel.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new, mongoose.event.backoffice.activities.options.EditableOptionsUiRoute::new, mongoose.catering.backoffice.activities.diningareas.DiningAreasUiRoute::new);
            ...
            case "dev.webfx.platform.gwt.services.resource.spi.impl.GwtResourceBundle": return new ServiceLoader<S>(mongoose.demo.all.backoffice.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(mongoose.demo.all.backoffice.application.MongooseBackOfficeApplication::new);
