...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.framework.client.operations.route.RouteRequestEmitter": return new ServiceLoader<S>(mongoose.base.backoffice.activities.monitor.RouteToMonitorRequestEmitter::new, mongoose.base.backoffice.activities.operations.RouteToOperationsRequestEmitter::new, mongoose.catering.backoffice.activities.diningareas.RouteToDiningAreasRequestEmitter::new, mongoose.crm.backoffice.activities.authorizations.RouteToAuthorizationsRequestEmitter::new, mongoose.crm.backoffice.activities.letters.RouteToLettersRequestEmitter::new, mongoose.crm.backoffice.activities.organizations.RouteToOrganizationsRequestEmitter::new, mongoose.crm.backoffice.activities.users.RouteToUsersRequestEmitter::new, mongoose.ecommerce.backoffice.activities.bookings.RouteToBookingsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.income.RouteToIncomeRequestEmitter::new, mongoose.ecommerce.backoffice.activities.payments.RouteToPaymentsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statements.RouteToStatementsRequestEmitter::new, mongoose.ecommerce.backoffice.activities.statistics.RouteToStatisticsRequestEmitter::new, mongoose.event.backoffice.activities.events.RouteToEventsRequestEmitter::new, mongoose.hotel.backoffice.activities.roomsgraphic.RouteToRoomsGraphicRequestEmitter::new);
            ...
            case "dev.webfx.framework.client.ui.uirouter.UiRoute": return new ServiceLoader<S>(mongoose.base.backoffice.activities.monitor.MonitorUiRoute::new, mongoose.base.backoffice.activities.operations.OperationsUiRoute::new, mongoose.catering.backoffice.activities.diningareas.DiningAreasUiRoute::new, mongoose.crm.backoffice.activities.authorizations.AuthorizationsUiRoute::new, mongoose.crm.backoffice.activities.letter.LetterUiRoute::new, mongoose.crm.backoffice.activities.letters.LettersUiRoute::new, mongoose.crm.backoffice.activities.organizations.OrganizationsUiRoute::new, mongoose.crm.backoffice.activities.users.UsersUiRoute::new, mongoose.crm.client.activities.login.LoginUiRoute::new, mongoose.crm.client.activities.unauthorized.UnauthorizedUiRoute::new, mongoose.ecommerce.backoffice.activities.bookings.BookingsUiRoute::new, mongoose.ecommerce.backoffice.activities.income.IncomeUiRoute::new, mongoose.ecommerce.backoffice.activities.payments.PaymentsUiRoute::new, mongoose.ecommerce.backoffice.activities.statements.StatementsUiRoute::new, mongoose.ecommerce.backoffice.activities.statistics.StatisticsUiRoute::new, mongoose.event.backoffice.activities.cloneevent.CloneEventUiRoute::new, mongoose.event.backoffice.activities.events.EventsUiRoute::new, mongoose.event.backoffice.activities.options.EditableOptionsUiRoute::new, mongoose.hotel.backoffice.activities.roomsgraphic.RoomsGraphicUiRoute::new);
